...
var Relationship = __webpack_require__(28);

document.addEventListener('DOMContentLoaded', function () {
  ReactDOM.render(React.createElement(Relationship), document.getElementById('mount'));
});
...
var HeartIcon = __webpack_require__(33);
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'td',
            null,
            React.createElement(HeartIcon, { imagePath: imagePath, isLoved: this.state.isLoved })
          ),
          React.createElement(
            'td',
            { style: { width: "150px" } },
            React.createElement(Message, { text: messageText })
          ),
          React.createElement(
            'td',
            null,
            React.createElement(Button, { text: buttonText, onClick: this.toggleLove })
          )
        )
      )
    );
...
var HeartIcon = function statelessFunctionComponentClass(props) {
  ...
  return React.createElement("img", { src: iconImagePath, alt: "Love status" });
};
